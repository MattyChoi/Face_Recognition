...
# Create a backward-compatible alias for `np.bool`
...
if __name__ == '__main__':
    ...
    # general
    parser.add_argument('--include', default='glint360k', type=str, help='')
    parser.add_argument('--output', default='face_imgs', type=str, help='')
